...
| Name | What |
|------|------|
| **LinkedIn Activation** | 27-post calendar. Cadence: alternating 1-week / 2-week gaps. Phase 1 (Posts 01–04) published; Phase-2 reshape May 26 2026 re-dated Posts 05–27 (Jun 2026 → Jan 2027). Post 04 LIVE May 26; Post 05 next. |
| **jmkay.com Perspectives** | Essay pages synced from published posts. Live: Posts 01–04 (see Published Perspectives list above). Deployed via Netlify from this repo. |
